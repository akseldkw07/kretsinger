...
# Apply LOWESS
# frac determines the fraction of data used for each local regression (controls smoothness)
smoothed = sm.nonparametric.lowess(y, x, frac=0.2)

# The output is a 2-column array: [sorted_x, smoothed_y]
...
sns.lmplot(x="x_values", y="y_values", data=df, lowess=True, line_kws={"color": "red"}, scatter_kws={"alpha": 0.6})
