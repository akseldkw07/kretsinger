...
class FloatPrecisionUtils:
    @classmethod
    def get_precision(cls, data_range: list[float | int] | np.ndarray):
        """
    ...
    @classmethod
    def notable_number(cls, num: float) -> bool:
        """
    ...
    @classmethod
    def smart_round(cls, values: pd.DataFrame | t.Iterable[float | int], max_decimals: int = 2):
        """
