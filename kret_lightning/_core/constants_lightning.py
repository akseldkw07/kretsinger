...
class CkptPatternTuple(t.NamedTuple):
...
class LightningDefaults:
    ...
    _CKPT_FILENAME = "best-{epoch:02d}-{val_loss:.2f}"  # NOTE don't change without update CKPT_BEST_PATTERN
    CKPT_TUPLE = CkptPatternTuple(pattern=_CKPT_BEST_PATTERN, filename=_CKPT_FILENAME)
